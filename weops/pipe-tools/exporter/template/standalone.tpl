...
metadata:
  ...
  namespace: postgres
spec:
  serviceName: pg-exporter-standalone-{{VERSION}}
  replicas: 1
  selector:
    matchLabels:
      app: pg-exporter-standalone-{{VERSION}}
  template:
    metadata:
      annotations:
    ...
    spec:
      ...
      - name: pg-exporter-standalone-{{VERSION}}
        ...
        - name: DATA_SOURCE_NAME
          value: "postgresql://postgres:Weops123!@pg-standalone-{{VERSION}}-postgresql.postgres:5432/postgres?sslmode=disable"
        securityContext:
