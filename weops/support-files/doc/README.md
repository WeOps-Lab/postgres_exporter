...
| process_cpu_seconds_total                    | PostgreSQL监控探针进程 CPU 使用时间总量        | -                                                             | -                                              | s        |
| process_resident_memory_bytes                | PostgreSQL监控探针进程占用的物理内存大小       | -                                                             | -                                              | bytes    |
| process_virtual_memory_bytes                 | PostgreSQL监控探针进程占用的虚拟内存大小       | -                                                             | -                                              | bytes    |
| process_open_fds                             | PostgreSQL监控探针进程打开的文件描述符数量     | -                                                             | -                                              | -        |
